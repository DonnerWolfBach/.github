...
* [mmCoreAndDevices](https://github.com/micro-manager/mmCoreAndDevices) contains the hardware abstraction layer (MMCore) and device adapters (modules that translate between the actual hardware and MMCore. These are all written in C++. Also contains the code to export MMCore to Java (MMCoreJ).
